...
import { VehicleType, Response } from '@/interfaces';
...
export const createOrUpdateVehicleType = async (formData: FormData): Promise<Response<VehicleType>> => {
