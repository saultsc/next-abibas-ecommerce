...
import { createOrUpdateVehicleStatus } from '@/actions/vehicle-status/create-update-vehicleStatus';
import { deleteVehicleStatus } from '@/actions/vehicle-status/delete-vehicleStatus';
...
export const VehicleStatusForm = ({ vehicleStatus }: Props) => {
	...
	const onSubmit = async (data: FormInputs) => {
		...
		const {
			...
			message,
		} = await createOrUpdateVehicleStatus(formData);
